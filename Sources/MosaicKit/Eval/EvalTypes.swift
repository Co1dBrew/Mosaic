...
public struct EvalCase: Sendable, Equatable, Codable, Identifiable {
    ...
    /// 期望被召回的**笔记** id。以笔记而非 chunk 为单位：chunk 会随策略变化，
    /// 而「这条 query 应该找到哪篇笔记」是稳定的人类判断。
    ...
    public init(id: String = UUID().uuidString,
        ...
        self.id = id
        self.query = query
        self.expectedNoteIDs = expectedNoteIDs
        self.source = source
...
public struct EvalMetrics: Sendable, Equatable, Codable {
    ...
    public init(caseCount: Int, recallAt1: Double, recallAt3: Double, recallAt5: Double,
...
public struct EvalRun: Sendable, Equatable {
    ...
    public var regressionPassRate: Double {
        regressionMetrics.caseCount == 0 ? 1.0 : regressionMetrics.recallAt5
    }
